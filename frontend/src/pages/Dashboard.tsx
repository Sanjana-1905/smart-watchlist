        ...
        {hasHighAttention && (
          <section className="mb-16">
            <div className="mb-8">
              ...
              <p className="text-gray-600 mt-2">Since your last check, these moved enough to stand out.</p>
              ...
              <tbody className="divide-y divide-gray-200">
                {data.items.map((item) => (
                  <tr key={item.symbol} className="hover:bg-gray-50">
                    ...
                    <td className={`text-right py-4 px-4 font-semibold ${item.session_change_pct >= 0 ? 'text-green-600' : 'text-red-600'}`}>
