...
export interface Analytics {
  ...
  temporal: {
    ...
    previous_session_observed_at: string | null;
    session_change_pct: number | null;
    session_return: number | null;
    last_viewed_price: number | null;
    last_viewed_at: string | null;
    since_last_view_pct: number | null;
    since_view_return: number | null;
    five_session_return_pct?: number | null;
  ...
  technical: {
    previous_window_max_close: number;
    sample_count: number;
    is_new_high: boolean;
  ...
  availability: { analytics_available: boolean; reason: string | null; available_history_count?: number };
  reasons: Reason[];
